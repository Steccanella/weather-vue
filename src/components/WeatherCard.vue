...
<template>
    <div class="text-white p-10 rounded-lg shadow-lg gap-6 mb-6 relative overflow-hidden" :class="place.current.is_day === 1 ? 'bg-day' : 'bg-night'">
        <!-- Location & time -->
        ...
        <div v-show="showDetail">
            <WeatherInfo :place="place" @close-info="showDetail=false" @remove-place="$emit('delete-place', place.location.name)"/>
        </div>
        </Transition>
